...
if __name__ == '__main__':
    ...
    for batch in testloader:
        ...
        hidden_wav = (mixed_wav + 100 * est_noise_wav) / max(abs(mixed_wav + 100 * est_noise_wav))  # path 2
        ...
        new_target_path = os.path.join(args.out_dir, 'new_target.wav')
        ...
        wavio.write(new_target_path, new_target_wav, 16000, sampwidth=2)
